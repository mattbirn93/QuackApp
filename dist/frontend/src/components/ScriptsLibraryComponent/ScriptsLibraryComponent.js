    ...
    const fetchScenes = async () => {
        try {
            ...
            if (axios.isAxiosError(error)) {
                ...
                if (error.response) {
                    console.log("HOW ABOUT THIS Error response data:", error.response.data);
                    console.log("HOW ABOUT THIS Error response status:", error.response.status);
                    console.log("HOW ABOUT THIS Error response headers:", error.response.headers);
                }
                else if (error.request) {
