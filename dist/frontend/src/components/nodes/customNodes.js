    ...
    addKeyboardShortcuts() {
        return {
            Enter: ({ editor }) => {
                ...
                const pos = $from.end();
                const transaction = state.tr.insert(pos, state.schema.nodes.dialogue.create());
                dispatch(transaction.setSelection(TextSelection.near(transaction.doc.resolve(pos + 1))));
                return true;
            },
        };
    },
