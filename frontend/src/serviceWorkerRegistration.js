...
export function register(config) {
    if (process.env.NODE_ENV === "production" && "serviceWorker" in navigator) {
        const publicUrl = new URL(import.meta.env.VITE_PUBLIC_URL || ".", // Provide a fallback value here
        window.location.href);
        console.log("WELCOME TURKEY PUBLIC_URL:", import.meta.env.VITE_PUBLIC_URL || "."); // Log PUBLIC_URL with fallback
        console.log("WELCOME TURKEY publicUrl.origin:", publicUrl.origin); // Log publicUrl.origin
        console.log("WELCOME TURKEY window.location.origin:", window.location.origin); // Log window.location.origin
        if (publicUrl.origin !== window.location.origin) {
            console.log("WELCOME TURKEY Service worker not registered due to origin mismatch.");
            return;
        }
        window.addEventListener("load", () => {
            ...
            if (isLocalhost) {
                ...
                navigator.serviceWorker.ready.then(() => {
                    console.log("WELCOME TURKEY This web app is being served cache-first by a service worker. To learn more, visit https://cra.link/PWA");
                });
            }
            else {
...
function registerValidSW(swUrl, config) {
    navigator.serviceWorker
            ...
            installingWorker.onstatechange = () => {
                if (installingWorker.state === "installed") {
                    if (navigator.serviceWorker.controller) {
                        console.log("WELCOME TURKEY New content is available and will be used when all tabs for this page are closed. See https://cra.link/PWA.");
        ...
        .catch((error) => {
        console.error("WELCOME TURKEY Error during service worker registration:", error);
    });
}
function checkValidServiceWorker(swUrl, config) {
    fetch(swUrl, {
        ...
        .catch(() => {
        console.log("WELCOME TURKEY No internet connection found. App is running in offline mode.");
    });
}
