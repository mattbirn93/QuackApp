  ...
  const handleCharacterButtonClick = (character) => {
    if (editor) {
      if (listening) {
        ...
        }, 0); // Small delay before starting the new recording
      }
    }
  };
...
// const customPasteHandler = new Plugin({
//   props: {
...
//         content.map((child) => {
//           const node = schema.nodeFromJSON(child.toJSON());
...
//             nodeType === "dialogue" ||
//             nodeType === "action" ||
//             nodeType === "sceneHeader"
//           ) {
//             return schema.node(nodeType, node.attrs, node.content);
//           } else {
//             return node;
//           }
//         }),
