...
import { fetchScriptsFull, updateScriptContent, updateScriptCharacters, updateScriptTitlePage, createScript, fetchScriptsById, } from '../controllers/scriptsFullController.js';
